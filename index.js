const  XBOT = 'AttalaBOT'; // Nama Bot Whatsapp
const instagram = 'https://www.instagram.com/kai_attala?r=nametag'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+6281291980377'; // Nomor whatsapplu cok
const aktif = 'Tergantung'; // Kapan bot lu aktif
const groupwa = 'comming soon'; // OFFICIAL GRUP LU 1
const youtube = 'comming soonn'; 
